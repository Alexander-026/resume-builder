...
// ─── Contact ──────────────────────────────────────────────────────────────────
export function ContactSection({ isEdit }: { isEdit: boolean }) {
...
// ─── Left: Education ──────────────────────────────────────────────────────────
export function EducationLeft({ section, isEdit }: { section: EducationSection; isEdit: boolean }) {
      ...
      {isEdit ? (
        ...
        section.items.map((item) => (
          <div key={item.id} style={{ marginBottom: 10 }}>
            ...
            <div className={s.eduDates}>{item.startDate}{item.endDate ? ` - ${item.endDate}` : ""}</div>
          </div>
        ))
      )}
    </div>
      ...
      {isEdit ? (
        ...
        section.items.map((item) => (
          <div key={item.id} className={s.entry}>
            ...
            <div className={s.entrySub}>{[item.company, item.location].filter(Boolean).join(" · ")}</div>
      ...
      {isEdit ? (
        ...
        section.items.map((item) => (
          <div key={item.id} className={s.entry}>
            ...
            <div className={s.entrySub}>{[item.school, item.location].filter(Boolean).join(" · ")}</div>
            {item.description && <p className={s.entryDesc}>{item.description}</p>}
          </div>
        ))
      )}
